  ...
  return (
    <>
      ...
      <div className="flex flex-col mt-20 justify-center items-start max-w-2xl mx-auto mb-16">
        ...
        <p className="text-xl text-gray-500 mb-4">{data.categories.map(category => category.title).join(', ')}</p>
        ...
        <div className="flex items-center text-white">
          <p className="mr-4 mt-5 mb-5 text-grey-300">Published at: {new Date(data.publishedAt).toLocaleDateString()}</p>
        </div>
